...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    company?: boolean
    password?: boolean
    Offer?: boolean | OfferFindManyArgs
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    Offer<T extends OfferFindManyArgs = {}>(args?: Subset<T, OfferFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Offer>>, PrismaPromise<Array<OfferGetPayload<T>>>>;
  ...
  export type AggregateUserOfferLibrary = {
    _count: UserOfferLibraryCountAggregateOutputType | null
    count: UserOfferLibraryCountAggregateOutputType | null
    _avg: UserOfferLibraryAvgAggregateOutputType | null
    avg: UserOfferLibraryAvgAggregateOutputType | null
    _sum: UserOfferLibrarySumAggregateOutputType | null
    sum: UserOfferLibrarySumAggregateOutputType | null
    _min: UserOfferLibraryMinAggregateOutputType | null
    min: UserOfferLibraryMinAggregateOutputType | null
    _max: UserOfferLibraryMaxAggregateOutputType | null
  ...
  export type UserOfferLibraryAggregateArgs = {
    ...
    **/
    _count?: true | UserOfferLibraryCountAggregateInputType
    /**
     * @deprecated since 2.23.0 please use `_count`
    **/
     ...
     * Select which fields to average
    **/
    _avg?: UserOfferLibraryAvgAggregateInputType
    /**
     * @deprecated since 2.23.0 please use `_avg`
    **/
     ...
     * Select which fields to sum
    **/
    _sum?: UserOfferLibrarySumAggregateInputType
    /**
     * @deprecated since 2.23.0 please use `_sum`
    **/
     ...
     * Select which fields to find the minimum value
    **/
    _min?: UserOfferLibraryMinAggregateInputType
    /**
     * @deprecated since 2.23.0 please use `_min`
    **/
     ...
     * Select which fields to find the maximum value
    **/
    _max?: UserOfferLibraryMaxAggregateInputType
    /**
     * @deprecated since 2.23.0 please use `_max`
    **/
  ...
  export type GetUserOfferLibraryAggregateType<T extends UserOfferLibraryAggregateArgs> = {
        [P in keyof T & keyof AggregateUserOfferLibrary]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
  ...
  export type UserOfferLibraryGroupByArgs = {
    where?: UserOfferLibraryWhereInput
    orderBy?: Enumerable<UserOfferLibraryOrderByInput>
    by: Array<UserOfferLibraryScalarFieldEnum>
    having?: UserOfferLibraryScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: UserOfferLibraryCountAggregateInputType | true
    _avg?: UserOfferLibraryAvgAggregateInputType
    _sum?: UserOfferLibrarySumAggregateInputType
    _min?: UserOfferLibraryMinAggregateInputType
    _max?: UserOfferLibraryMaxAggregateInputType
  ...
  export type UserOfferLibraryGroupByOutputType = {
    offerId: string
    userId: number
    _count: UserOfferLibraryCountAggregateOutputType | null
    _avg: UserOfferLibraryAvgAggregateOutputType | null
  ...
  type GetUserOfferLibraryGroupByPayload<T extends UserOfferLibraryGroupByArgs> = Promise<
    Array<
      PickArray<UserOfferLibraryGroupByOutputType, T['by']> & 
        {
          [P in ((keyof T) & (keyof UserOfferLibraryGroupByOutputType))]: P extends '_count' 
            ? T[P] extends boolean 
              ? number 
              : GetScalarType<T[P], UserOfferLibraryGroupByOutputType[P]> 
            : GetScalarType<T[P], UserOfferLibraryGroupByOutputType[P]>
        }
      > 
    >
  ...
  export interface UserOfferLibraryDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    /**
     * Create many UserOfferLibraries.
     *     @param {UserOfferLibraryCreateManyArgs} args - Arguments to create many UserOfferLibraries.
     *     @example
     *     // Create many UserOfferLibraries
     *     const userOfferLibrary = await prisma.userOfferLibrary.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends UserOfferLibraryCreateManyArgs>(
      args?: SelectSubset<T, UserOfferLibraryCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    ...
    /**
     * Group by UserOfferLibrary.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {UserOfferLibraryGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends UserOfferLibraryGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: UserOfferLibraryGroupByArgs['orderBy'] }
        : { orderBy?: UserOfferLibraryGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, UserOfferLibraryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserOfferLibraryGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type UserOfferLibraryCreateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<UserOfferLibraryCreateInput, UserOfferLibraryUncheckedCreateInput>
  }


  /**
   * UserOfferLibrary createMany
   */
  export type UserOfferLibraryCreateManyArgs = {
    data: Enumerable<UserOfferLibraryCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type UserOfferLibraryUpdateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<UserOfferLibraryUpdateInput, UserOfferLibraryUncheckedUpdateInput>
    /**
  ...
  export type UserOfferLibraryUpdateManyArgs = {
    data: XOR<UserOfferLibraryUpdateManyMutationInput, UserOfferLibraryUncheckedUpdateManyInput>
    where?: UserOfferLibraryWhereInput
  }
  ...
  export type UserOfferLibraryUpsertArgs = {
    ...
    **/
     ...
     * 
    **/
    create: XOR<UserOfferLibraryCreateInput, UserOfferLibraryUncheckedCreateInput>
    /**
     * In case the UserOfferLibrary was found with the provided `where` argument, update it with this data.
     * 
    **/
    update: XOR<UserOfferLibraryUpdateInput, UserOfferLibraryUncheckedUpdateInput>
  }
  ...
  export type UserOfferLibraryScalarWhereWithAggregatesInput = {
    AND?: Enumerable<UserOfferLibraryScalarWhereWithAggregatesInput>
    OR?: Enumerable<UserOfferLibraryScalarWhereWithAggregatesInput>
    NOT?: Enumerable<UserOfferLibraryScalarWhereWithAggregatesInput>
  ...
  export type OfferScalarWhereWithAggregatesInput = {
    ...
    how_to_apply?: StringWithAggregatesFilter | string
    company_url?: StringNullableWithAggregatesFilter | string | null
  ...
  export type UserCreateInput = {
    ...
    company: string
    password: string
    Offer?: OfferCreateNestedManyWithoutUserInput
  ...
  export type UserUncheckedCreateInput = {
    ...
    company: string
    password: string
    Offer?: OfferUncheckedCreateNestedManyWithoutUserInput
  ...
  export type UserUncheckedUpdateInput = {
    ...
    company?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    Offer?: OfferUncheckedUpdateManyWithoutUserInput
  ...
  export type UserOfferLibraryCreateManyInput = {
    offerId: string
    userId: number
  }
  ...
  export type OfferCreateInput = {
    ...
    User: UserCreateNestedOneWithoutOfferInput
  }
  ...
  export type OfferCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<OfferCreateWithoutUserInput>, Enumerable<OfferUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<OfferCreateOrConnectWithoutUserInput>
  ...
  export type UserOfferLibraryCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<UserOfferLibraryCreateWithoutUserInput>, Enumerable<UserOfferLibraryUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<UserOfferLibraryCreateOrConnectWithoutUserInput>
    createMany?: UserOfferLibraryCreateManyUserInputEnvelope
  ...
  export type OfferUpdateManyWithoutUserInput = {
    create?: XOR<Enumerable<OfferCreateWithoutUserInput>, Enumerable<OfferUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<OfferCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<OfferUpsertWithWhereUniqueWithoutUserInput>
    createMany?: OfferCreateManyUserInputEnvelope
    connect?: Enumerable<OfferWhereUniqueInput>
    set?: Enumerable<OfferWhereUniqueInput>
    disconnect?: Enumerable<OfferWhereUniqueInput>
    delete?: Enumerable<OfferWhereUniqueInput>
    update?: Enumerable<OfferUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<OfferUpdateManyWithWhereWithoutUserInput>
  ...
  export type UserCreateNestedOneWithoutUserOfferLibraryInput = {
    create?: XOR<UserCreateWithoutUserOfferLibraryInput, UserUncheckedCreateWithoutUserOfferLibraryInput>
  ...
  export type UserUpdateOneRequiredWithoutUserOfferLibraryInput = {
    ...
    connect?: UserWhereUniqueInput
    update?: XOR<UserUpdateWithoutUserOfferLibraryInput, UserUncheckedUpdateWithoutUserOfferLibraryInput>
  }
  ...
  export type OfferCreateManyUserInputEnvelope = {
    data: Enumerable<OfferCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type UserOfferLibraryCreateOrConnectWithoutUserInput = {
    where: UserOfferLibraryWhereUniqueInput
    create: XOR<UserOfferLibraryCreateWithoutUserInput, UserOfferLibraryUncheckedCreateWithoutUserInput>
  }

  export type UserOfferLibraryCreateManyUserInputEnvelope = {
    data: Enumerable<UserOfferLibraryCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type UserOfferLibraryUpsertWithWhereUniqueWithoutUserInput = {
    where: UserOfferLibraryWhereUniqueInput
    update: XOR<UserOfferLibraryUpdateWithoutUserInput, UserOfferLibraryUncheckedUpdateWithoutUserInput>
    create: XOR<UserOfferLibraryCreateWithoutUserInput, UserOfferLibraryUncheckedCreateWithoutUserInput>
  }

  export type UserOfferLibraryUpdateWithWhereUniqueWithoutUserInput = {
    where: UserOfferLibraryWhereUniqueInput
    data: XOR<UserOfferLibraryUpdateWithoutUserInput, UserOfferLibraryUncheckedUpdateWithoutUserInput>
  }

  export type UserOfferLibraryUpdateManyWithWhereWithoutUserInput = {
    where: UserOfferLibraryScalarWhereInput
    data: XOR<UserOfferLibraryUpdateManyMutationInput, UserOfferLibraryUncheckedUpdateManyWithoutUserOfferLibraryInput>
  }
  ...
  export type UserOfferLibraryCreateManyUserInput = {
    offerId: string
  }
